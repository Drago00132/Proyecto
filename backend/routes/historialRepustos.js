...
router.post('/agregar', upload.single('fotos'), verificarToken, verificarRol(1,3,16,17), historial.agregarHistorial);
router.put('/actualizar/:id', upload.single('fotos'), verificarToken, verificarRol(1,2,3,16,17), historial.actualizarHistorial);
